...
export class FileStats implements IFileStats {
    ...
    sizeGB?: number;
    isH264File?: boolean;
    possibleGBSavings?: number;

    constructor(data?: IFileStats) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.isH264File = _data["isH264File"];
            this.possibleGBSavings = _data["possibleGBSavings"];
        }
    }

    static fromJS(data: any): FileStats {
        data = typeof data === 'object' ? data : {};
        let result = new FileStats();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["isH264File"] = this.isH264File;
        data["possibleGBSavings"] = this.possibleGBSavings;
        return data;
    }
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["h264FileNames"])) {
                ...
                for (let item of _data["h264FileNames"])
                    this.h264FileNames!.push(FileStats.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.h264FileNames)) {
            ...
            for (let item of this.h264FileNames)
                data["h264FileNames"].push(item.toJSON());
        }
